            ...
            success: function (data) { 
                ...
                $.each(data, function(index, element) {
                    var templateRow = `<tr>
                                        ...
                                        <td>${element.apellidoPaterno} ${element.apellidoMaterno}, ${element.nombre}</td>
                                        <td>${element.especialidad.nombre}</td>
                                        <td width="10%" align="center">
                                            <button class="btn btn-info bnt_editar" data-id="${element.idMedico}"><i class="fa fa-edit "></i> Editar</button>&nbsp;&nbsp;
                                            <!--<button class="btn btn-danger" bnt_eliminar data-id="${element.idMedico}"><i class="fa fa-pencil"></i> Eliminar</button>-->
                                        </td>
                                    </tr>`;
